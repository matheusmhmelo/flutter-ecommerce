...
class Store {
       ...
       if(timeString != null && timeString.isNotEmpty) {
          ...
          return MapEntry(
            key,
            {
              ...
              "to": TimeOfDay(
                  hour: int.parse(splited[2]),
                  minute: int.parse(splited[3])
              )
            }
          );
       } else {
  ...
  String get addressText => "${address.street}, ${address.number}${address.complement.isNotEmpty ? ' - ${address.complement}': ''} - "
